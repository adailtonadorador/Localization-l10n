      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
        <div className="container flex h-16 items-center justify-between">
          <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <div>
              <span className="text-lg sm:text-xl font-bold text-blue-700">Sama Conecta</span>
              <span className="text-[10px] sm:text-xs text-slate-500 block -mt-1">Conectando Oportunidades</span>
            </div>
          </Link>

          <nav className="hidden md:flex items-center gap-8">
            <a href="#como-funciona" className="text-sm font-medium text-slate-600 hover:text-blue-500 transition-colors">
              Como Funciona
            </a>
            <a href="#para-trabalhadores" className="text-sm font-medium text-slate-600 hover:text-blue-500 transition-colors">
              Para Trabalhadores
            </a>
            <a href="#para-empresas" className="text-sm font-medium text-slate-600 hover:text-blue-500 transition-colors">
              Para Empresas
            </a>
          </nav>
            ...
            <div className="container py-4 space-y-3">
              ...
              <div className="pt-3 border-t flex gap-3">
                ...
                <Link to="/register" className="flex-1">
                  <Button className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800">Cadastrar</Button>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><a href="#para-empresas" className="hover:text-blue-500 transition-colors">Para Empresas</a></li>
                <li><a href="#para-trabalhadores" className="hover:text-blue-500 transition-colors">Para Trabalhadores</a></li>
